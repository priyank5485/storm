...
function confirmComponentAction(name, componentId, componentName, action, param,
 defaultParamValue, paramText, actionText) {
    var opts = {
        type:'POST',
        url:'/api/v1/topology/' + name + '/component/' + componentId + '/' +
        action
    };
